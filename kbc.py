...
response = requests.get("https://opentdb.com/api.php?amount=15&category=9&difficulty=medium")
# print(response.status_code)
# print(response.json())
# question  =response.json()['results'][0]['question']
# print(question)
# ca =response.json()['results'][0]['correct_answer']
# print(ca)
# ica  =response.json()['results'][0]['incorrect_answers']
# print(ica)
